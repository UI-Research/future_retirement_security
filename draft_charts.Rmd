...
plotr(titler("Age 70 Percentage of People Who Fail to Replace 75% of Age 50-59 Earnings"),
      chart1,
      caption,
      sourcer("DYNASIM4"),
      heights = c(2, 30, 1, 1))
...
chart2 <- plotr(titler("Age-70, per-capita, price-adjusted income"),
      subtitler("Median shared annuitized income with imputed rent, other income, and taxes"),
      chart2,
      caption,
      sourcer("DYNASIM4"),
      heights = c(1.8, 1, 30, 1, 1))

ggsave("charts/chart2.pdf", 
       chart2,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
...
```{r chart3}
chart3 <- read_csv("data/figure3.csv") %>%
  filter(doby %in% cohorts) %>%
...
plotr(titler("Age-70, per-capita, price-adjusted, shared annuitized income with imputed rent, other income, and taxes"),
      subtitler("By sex"),
      chart3,
      caption,
      sourcer("DYNASIM4"),
...
chart3 <- plotr(titler("Median Age-70 Price-Adjusted Social Security Benefits by Sex"),
      chart3b,
      caption,
      sourcer("DYNASIM4"),
      heights = c(2, 30, 1, 1))

ggsave("charts/chart3.pdf", 
       chart3,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
...
chart4 <- plotr(titler("Median Price-adjusted Earnings from Ages 25 to 69 at Age 70"),
      subtitler("By sex"),
      chart4,
      caption,
      sourcer("DYNASIM4"),
...
chart5 <- plotr(titler("Social Security Benefit Type at Age 70 for Female Beneficiaries (%)"),
      chart5,
      caption,
      sourcer("DYNASIM4"),
      heights = c(2, 30, 1, 1))

ggsave("charts/chart5.pdf", 
       chart5,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
...
chart6 <- plotr(titler("Age-70, per-capita, price-adjusted, shared annuitized income\nwith imputed rent, other income, and taxes"),
      subtitler("By race and ethnicity"),
      chart6,
      caption,
      sourcer("DYNASIM4"),
      heights = c(5, 1, 30, 1, 1))

ggsave("charts/chart6.pdf", 
       chart6,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
...
```{r chart8}
chart8 <- read_csv("data/figure8.csv") %>%
  filter(doby %in% cohorts) %>%
  select(doby,
...
chart8 <- plotr(titler("Median Annual Social Security Benefit at Age 70"),
      subtitler("Among People with Social Security Benefits"),
      chart8,
      caption,
      sourcer("DYNASIM4"),
      heights = c(1.8, 1, 30, 1, 1))

ggsave("charts/chart8.pdf", 
       chart8,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
...
```{r, chart9}
chart9 <- read_csv("data/figure9.csv") %>%
...
chart9 <- plotr(titler("Age 70 Percentage of People Who fail to Replace 75% of Age 50-59 Earnings"),
      subtitler("Social Security benefits under payable law"),
      chart9,
      caption,
      sourcer("DYNASIM4"),
      heights = c(1.8, 1, 30, 1, 1))

ggsave("charts/chart9.pdf", 
       chart9,
       device = cairo_pdf(),
       width = 6.5,
       height = 5,
