...
plotr(titler("A typical Xennial retiree will receive about 30 percent more net income than a typical retiree born 40 years earlier", width = 60),
...
# create the output plot
plotr(titler("Over her lifetime, a typical Xennial woman will earn more than twice as much as her pre-boomer counterpart"),
...
# create the output plot
plotr(titler("Nearly one-third of Xennials will see their living standards fall when they retire", width = 61),
...
# create the output plot
plotr(titler("Social Security accounts for about 85 percent of income for low-income beneficiaries"),
...
# create the output plot
plotr(titler("A 25 percent Social Security benefit cut could leave about 1 in 12 Gen X and Xennial retirees in poverty"),
...
# create the output plot
plotr(titler("Although retirement incomes are projected to rise for people of color, they will continue to lag far behind incomes for non-Hispanic white people"),
      subtitler("Median annual per capita after-tax family income at age 70 (constant 2018 dollars)"),
      chart6,
      caption,
      sourcer("DYNASIM4, ID963."),
...
# create the output plot
plotr(titler("For Xennials, women’s median Social Security benefits at age 70 will rise to 85 percent of the median for men"),
